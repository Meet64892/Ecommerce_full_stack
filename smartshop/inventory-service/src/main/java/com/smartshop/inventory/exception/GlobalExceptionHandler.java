...
/**
 * GlobalExceptionHandler - Centralized error mapping for the inventory-service.
 *
 * <h2>Purpose</h2>
 * Converts exceptions to the shared {@link ErrorResponse} for a consistent
 * error contract.
 *
 * <h2>How it fits in the system</h2>
 * Applies to every inventory controller.
 *
