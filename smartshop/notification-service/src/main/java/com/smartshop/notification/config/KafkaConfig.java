 ...
 *
 * <h2>Purpose</h2>
 * Configures the Kafka consumer for notification-service.
 * This service ONLY consumes (never produces) — it receives events and
 * triggers email sending. No producer configuration needed.
 *
